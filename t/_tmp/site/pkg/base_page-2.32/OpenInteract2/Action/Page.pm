...
# $Id: Page.pm,v 1.27 2005/03/18 04:09:44 lachoy Exp $
...
$OpenInteract2::Action::Page::VERSION = sprintf("%d.%02d", q$Revision: 1.27 $ =~ /(\d+)\.(\d+)/);
...
sub _show_displayable_page {
    ...
    return $self->generate_content(
                    \%params, { name => 'base_page::page_displayable' });
}
