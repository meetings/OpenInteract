...
# $Id: User.pm,v 1.15 2005/03/18 04:09:45 lachoy Exp $
...
$OpenInteract2::SQLInstall::User::VERSION = sprintf("%d.%02d", q$Revision: 1.15 $ =~ /(\d+)\.(\d+)/);
...
sub get_data_file {
    return 'install_user_language.dat';
}
