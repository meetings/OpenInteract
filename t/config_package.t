...
# $Id: config_package.t,v 1.9 2004/09/26 16:06:01 lachoy Exp $
...
my %filter        = ( myfilter => 'OpenInteract2::Filter::My' );
...

{
    ...
    is_deeply( $c->config_watcher( \@config_watch ), \@config_watch,
               'Config watcher set' );
    is_deeply( $c->observer( \%filter ), \%filter,
               'Observer set' );
