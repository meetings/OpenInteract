...
# $Id: config_base.t,v 1.10 2004/06/06 06:13:40 lachoy Exp $
...

{
    ...
    my $filename = OpenInteract2::Config::Base
                                   ->create_filename( $dir );
    is( $filename, catfile( $dir, 'base.conf' ),
        'Create default filename' );
    my $web_filename = OpenInteract2::Config::Base
                                   ->create_website_filename( $dir );
    is( $web_filename, catfile( $dir, 'conf', 'base.conf' ),
...
my $existing_file = catfile( $website_dir, 'conf', 'base.conf' );
