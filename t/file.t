...
# $Id: file.t,v 1.12 2003/04/30 04:00:14 lachoy Exp $
...
is( OpenInteract2::File->check_file( $check_ok ),
    File::Spec->catfile( $website_dir, split( '/', $check_ok ) ),
    'Check file success' );
is( OpenInteract2::File->check_file( $check_fail ), undef,
