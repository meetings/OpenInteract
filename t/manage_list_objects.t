...
# $Id: manage_list_objects.t,v 1.6 2004/06/06 06:36:03 lachoy Exp $
...
my @names = qw(
    ...
    full_text_mapping group news news_section object_action page page_content
    page_directory security theme themeprop user user_language whats_new
);
my @classes = map { "OpenInteract2::$_" } qw(
    Comment CommentNotify CommentSummary ContentType ErrorObject
    FullTextMapping Group News NewsSection ObjectAction Page PageContent
