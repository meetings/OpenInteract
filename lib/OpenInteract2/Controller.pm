...
# $Id: Controller.pm,v 1.23 2004/09/26 23:52:42 lachoy Exp $
...
$OpenInteract2::Controller::VERSION  = sprintf("%d.%02d", q$Revision: 1.23 $ =~ /(\d+)\.(\d+)/);
...
sub new {
    ...
    # Add a filter (observer) at runtime to the main action. So you
    # could do:
    #
