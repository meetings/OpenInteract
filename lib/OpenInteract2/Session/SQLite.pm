...
L<OpenInteract2::Session|OpenInteract2::Session> so we can use a SQLite
...
L<OpenInteract2::Session|OpenInteract2::Session>, serializing sessions
to and from a file named in the configuration.
