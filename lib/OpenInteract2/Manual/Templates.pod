...
'HTMLT' (HTML::Template) and 'TextTmpl' (Text::Template).
...
might look like:
  ...
  [timelimit template_source]
  list_time_limit = mypkg::userlist_normal
  ...
  [timelimit template_source]
  list_time_limit = mypkg::userlist_plain
