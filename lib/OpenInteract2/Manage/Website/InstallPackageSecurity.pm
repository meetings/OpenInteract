...
# $Id: InstallPackageSecurity.pm,v 1.6 2003/07/14 13:08:38 lachoy Exp $
...
$OpenInteract2::Manage::Website::InstallPackageSecurity::VERSION = sprintf("%d.%02d", q$Revision: 1.6 $ =~ /(\d+)\.(\d+)/);
