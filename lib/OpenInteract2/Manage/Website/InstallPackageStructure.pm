...
# $Id: InstallPackageStructure.pm,v 1.7 2003/06/11 02:43:28 lachoy Exp $
...
$OpenInteract2::Manage::Website::InstallPackageStructure::VERSION = sprintf("%d.%02d", q$Revision: 1.7 $ =~ /(\d+)\.(\d+)/);
